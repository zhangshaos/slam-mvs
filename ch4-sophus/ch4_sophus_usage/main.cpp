...
int main(int argc, char** argv) {
  ...
  // Sophus::SO3d SO3_v(0, 0, M_PI / 2);  // 亦可从旋转向量构造，新版的不行了
  ...
  // 增量扰动模型的更新
  Eigen::Vector3d update_so3(0.1, 0, 0);  //假设更新量为这么多
  Sophus::SO3d SO3_updated = Sophus::SO3d::exp(update_so3) * SO3_R;
  cout << "扰动：" << update_so3.transpose() << endl;
  ...
  cout << "扰动：" << update_se3.transpose() << endl;
