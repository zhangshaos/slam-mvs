...
int main(int argc, char** argv) {
  ...
  //-- 建立3D点
  Mat depth1 = imread(R"(E:\git_repos\slambook\ch7\1_depth.png)");  // 深度图为16位无符号数，单通道图像
  Mat depth2 = imread(R"(E:\git_repos\slambook\ch7\2_depth.png)");  // 深度图为16位无符号数，单通道图像
